function test_permuttest2
%TEST_PERMUTTEST2  Unit tests for permuttest2.m.
...
for i = 1:numel(tail)
    ...
    [t2,p2,ci2,stats2] = permuttest2(x,y,'tail',tail{i},'correct',0);
...
disp('All unit tests for permuttest2.m passed.')