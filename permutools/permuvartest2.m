...
%
%   For continuous heavy-tailed data, the raw data may be transformed to
%   squared ranks in order to compute a permutation-based Conover squared
%   ranks test by setting the 'type' parameter to 'squarerank' or 'rank'.
%
